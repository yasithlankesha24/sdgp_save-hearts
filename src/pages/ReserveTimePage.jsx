        ...
        <div>
            <div className="reserve-time page">
                <div className="cover-image">
                    <img src={"/assets/images/reserve-time/reserve-time-cover-image.png"} alt=""/>

                    <div className="cover-image-content">
                        <div className={"cover-image-heading"}>Reserve a time to donate blood</div>
                        <div className={"cover-image-description"}>Online reservation allows individuals to schedule a time to donate blood through an online platform.</div>
                    </div>
                </div>
                <Container>
                    <Row>
                        ...
                        <Col md={5}>
                            <div className="reserve-time-content">
                                <div className="section-title">
                                    <div className={"title-text"}>Reserve a time</div>
                                </div>
